...
Test framework to be wrapped in pod.
                   DESC
  ...
  spec.author             = { "Olha Salii" => "olha.salii@ctdev.io" }
  # Or just: spec.author    = "Olha Salii"
  # spec.authors            = { "Olha Salii" => "olha.salii@ctdev.io" }
  # spec.social_media_url   = "https://twitter.com/Olha Salii"
